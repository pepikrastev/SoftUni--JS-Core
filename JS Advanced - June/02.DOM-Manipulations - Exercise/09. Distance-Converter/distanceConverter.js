function attachEventsListeners() {
    ...
    function converting(){
        ...
        let fromUnit = fromUnits.options[fromUnits.selectedIndex].value;
        
        let toUnits = document.getElementById('outputUnits');
        let toUnit = toUnits.options[toUnits.selectedIndex].value;

        let convertedDistance = converter[fromUnit][toUnit](distance);
